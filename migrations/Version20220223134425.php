 ...
 */
final class Version20220223134425 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE kanji_key CHANGE number_key number_key INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE kanji_key CHANGE number_key number_key INT NOT NULL');
